...
return [
    'modules' => [
        ...
        'Shellpea_Castom' => 0,
        'Shellpea_Content' => 0,
        'Shellpea_CustomerList' => 0,
        'Shellpea_DB' => 0,
        'Shellpea_Event' => 0,
        'Shellpea_HalloWorld' => 0,
        'Shellpea_HelloWorld' => 0,
        'Shellpea_LogSaveProduct' => 0,
        'Shellpea_MegaQuest' => 1,
        'Shellpea_Module' => 0,
        'Shellpea_MultiAttribute' => 0,
        'Shellpea_NewAttribute' => 0,
        'Shellpea_NewModule' => 0,
        'Shellpea_PriorAttribut' => 0,
        'Shellpea_ProductList' => 0,
        'Shellpea_Stores' => 1,
        'Shellpea_Template' => 0,
